  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        {...(isInView ? { stroke: "#65a30d", animate: { pathLength: 1 } } : {})}
        onUpdate={({ pathLength }) => {
  ...
  return (
    ...
    <div className="p-4">
      <div className="mt-3 border-t border-gray-200 pt-5">
          ...
          {percentageChange && (
            <div
              className={clsx(
                ...
                percentageChange >= 0 ? "text-lime-500" : "text-gray-500"
              )}
            >
        ...
        <div className="mt-4 rounded-lg bg-lime-500 px-4 py-2 text-center text-sm font-semibold text-white">
          Trade
        </div>
